use super::{Celsius, Device, MeasurementValue, Rpm};
...
impl DaqMessage {
    pub fn new_temperature(
        ...
        Self::Temperature { source, samples }
    }
    pub fn new_wheel_speed(source: Device, rpm: Rpm) -> Self {
        Self::WheelSpeed { source, rpm }
    }
    pub fn new_imu(source: Device, samples: [ImuSample; IMU_SAMPLE_COUNT]) -> Self {
        Self::Imu { source, samples }
    }
}
